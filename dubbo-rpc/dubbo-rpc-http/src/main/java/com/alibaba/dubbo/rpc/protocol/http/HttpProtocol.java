...
public class HttpProtocol extends AbstractProxyProtocol {
    ...
    protected <T> T doRefer(final Class<T> serviceType, final URL url) throws RpcException {
        ...
        if (client == null || client.length() == 0 || "simple".equals(client)) { //  JDK HttpClient 创建执行器 SimpleHttpInvokerRequestExecutor 对象
        ...
        } else if ("commons".equals(client)) { // Apache HttpClient 创建执行器 HttpComponentsHttpInvokerRequestExecutor 对象
